            ...
            <div className="infoBlock">
                <div className="info">
                    ...
                    <div className="dateOfBirth row center">
                        <h2><span className="titleInfoLine">Дата рождения:</span> 17.10.1998</h2>
                    </div>
                    <div className="city row center">
                        <h2><span className="titleInfoLine">Город: </span> Новосибирск</h2>
                    </div>
                    </div>
                    <div className="decorLine"></div>
                    ...
                    <div className="writePost row center">
